...
import urban.fresh.shop.adapter.CategoryAdapter
import urban.fresh.shop.adapter.OfferAdapter
import urban.fresh.shop.adapter.SectionAdapter
import urban.fresh.shop.adapter.SliderAdapter
import urban.fresh.shop.helper.ApiConfig.Companion.addMarkers
import urban.fresh.shop.helper.ApiConfig.Companion.getOfferImage
...
import urban.fresh.shop.model.Category
import urban.fresh.shop.model.Section
import urban.fresh.shop.model.Slider
import java.util.*
                    ...
                    try {
                        ...
                        if (!jsonObject.getBoolean(Constant.ERROR)) {
                            if (jsonObject.getJSONArray(Constant.FLASH_SALES).length() != 0) {
                                ...
                                Log.d("ggggggg",jsonObject.getJSONArray(Constant.FLASH_SALES).toString());
