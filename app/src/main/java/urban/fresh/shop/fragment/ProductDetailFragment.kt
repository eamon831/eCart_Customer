package urban.fresh.shop.fragment
...
import urban.fresh.shop.R
import urban.fresh.shop.activity.MainActivity
import urban.fresh.shop.adapter.AdapterStyle1
import urban.fresh.shop.adapter.ProductLoadMoreAdapter
import urban.fresh.shop.adapter.ReviewAdapter
import urban.fresh.shop.adapter.SliderAdapter
import urban.fresh.shop.helper.ApiConfig.Companion.addMarkers
import urban.fresh.shop.helper.ApiConfig.Companion.addMultipleProductInCart
import urban.fresh.shop.helper.ApiConfig.Companion.addOrRemoveFavorite
import urban.fresh.shop.helper.ApiConfig.Companion.buildCounterDrawable
import urban.fresh.shop.helper.ApiConfig.Companion.calculateDays
import urban.fresh.shop.helper.ApiConfig.Companion.getCartItemCount
import urban.fresh.shop.helper.ApiConfig.Companion.getDiscount
import urban.fresh.shop.helper.ApiConfig.Companion.getSettings
import urban.fresh.shop.helper.ApiConfig.Companion.isConnected
import urban.fresh.shop.helper.ApiConfig.Companion.requestToVolley
import urban.fresh.shop.helper.ApiConfig.Companion.stringFormat
import urban.fresh.shop.helper.ApiConfig.Companion.toTitleCase
import urban.fresh.shop.helper.Constant
import urban.fresh.shop.helper.DatabaseHelper
import urban.fresh.shop.helper.Session
import urban.fresh.shop.helper.Utils.setFormatTime
import urban.fresh.shop.helper.VolleyCallback
import urban.fresh.shop.model.*
